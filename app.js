...
async function saveComm(ev,id){
  ev.preventDefault(); const role=document.getElementById('cf-role').value.trim(), name=document.getElementById('cf-name').value.trim(), phone=document.getElementById('cf-phone').value.trim();
